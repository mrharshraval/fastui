...
class BusinessNameNormalizer:
    """Conservative normalizer for business names."""
    ...
    @classmethod
    def normalize(cls, raw_name: str | None) -> NormalizedBusinessName:
    ...
    def resolve_canonical_name(
        ...
        Resolves authoritative canonical name by cross-referencing scraped source display names
