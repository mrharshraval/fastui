...
class WebSearchScraper(PlaywrightScraper):
    """
    Scrapes public web search engines (DuckDuckGo / Bing / B2B portals) 
    to discover business websites, contact emails, phone numbers, and company profiles.
    """
    ...
    async def extract_leads(self, page: Page, params: DiscoverySearchParams) -> List[DiscoveredLead]:
        ...
        logger.info(f"WebSearchScraper: Searching web for '{search_query}'")
        try:
        ...
        try:
            ...
            for res in results[:min(params.limit, 20)]:
                try:
                    ...
                    # Clean title separators like " | Official Site" or " - Home"
                    ...
                    # Skip search engine aggregator sites
