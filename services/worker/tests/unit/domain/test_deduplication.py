...
def test_identical_name_without_supporting_metadata_is_not_duplicate():
    ...
    assert same_business(lead1, lead2) is False
...
def test_identical_name_with_different_locations_is_not_duplicate():
    ...
    assert same_business(lead3, lead4) is False
    ...
    assert same_business(lead5, lead6) is False
...
def test_identical_name_with_supporting_evidence_is_duplicate():
    ...
    assert same_business(lead1, lead2) is True
    ...
    assert same_business(lead3, lead4) is True
