"""
FastUI Worker Structured Logging System (Cloud Run / OpenTelemetry Standard)
=============================================================================
...
def redact_sensitive_data(data: Any) -> Any:
    """Recursively redacts sensitive tokens and secrets from logged metadata."""
...
def setup_worker_logging(
    ...
    """Configures root logger with appropriate environment formatter."""
