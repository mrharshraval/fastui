            ...
            <section className="w-full py-24 bg-muted md:bg-muted/30">
                <div className="container px-8 sm:px-4 md:px-12">
                    <div className="mb-16 space-y-4 text-center md:text-left">
                        <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Why Choose Brainlab?</h2>
                        <p className="text-muted-foreground text-lg max-w-2xl mx-auto md:mx-0">
                            We combine advanced technology with a human touch to provide the best dental experience.
                        </p>
                    </div>
                    <div className="grid gap-8 md:grid-cols-3">
                        {[
                            { title: "Advanced Technology", desc: "Digital X-rays, 3D imaging, and laser dentistry for precise treatments." },
                            { title: "Comfort-First Approach", desc: "Relaxing environment, sedation options, and gentle care for anxious patients." },
                            { title: "Expert Team", desc: "Highly trained specialists dedicated to your oral health and beautiful smile." },
                        ].map((feature, i) => (
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-12 gap-4 text-center md:text-left">
                        <div className="space-y-4 max-w-2xl mx-auto md:mx-0">
                            ...
                            <p className="text-muted-foreground text-lg">
                                From routine checkups to complete smile makeovers, we offer a full range of services.
                            </p>
                        </div>
                        <Link href="/treatments" className="hidden md:flex items-center text-primary font-medium hover:underline">
                            View all treatments <ArrowRight className="ml-2 h-4 w-4" />
                        </Link>
                    </div>
                    <div className="grid gap-6 md:grid-cols-3">
                        {[
                            { title: "Cosmetic Dentistry", desc: "Veneers, whitening, and bonding.", href: "/treatments/cosmetic" },
                            { title: "Dental Implants", desc: "Permanent solutions for missing teeth.", href: "/treatments/implants" },
                            { title: "Orthodontics", desc: "Invisalign and modern braces.", href: "/treatments/orthodontics" },
                        ].map((service, i) => (
                            <Link key={i} href={service.href} className="group relative overflow-hidden rounded-xl bg-muted/50 p-8 flex flex-col justify-between items-center text-center md:items-start md:text-left h-full min-h-[220px]">
                                <div>
            ...
            <section className="w-full py-24 bg-muted md:bg-muted/30">
                <div className="container px-8 sm:px-4 md:px-12">
                    ...
                    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                        {[
                            { name: "Sarah J.", text: "I used to be terrified of the dentist, but the team at Brainlab made me feel so comfortable. My new veneers look amazing!" },
                            { name: "Michael T.", text: "Professional, clean, and high-tech. I had a root canal done and didn't feel a thing. Highly recommend." },
                            { name: "Emily R.", text: "Best dental experience I've ever had. The staff is friendly and the results of my Invisalign treatment are perfect." },
                        ].map((testimonial, i) => (
