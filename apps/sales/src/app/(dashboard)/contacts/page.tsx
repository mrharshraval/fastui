...
export default function ContactsPage() {
 ...
 const isAllVisibleSelected = filtered.length> 0 && filtered.every(c => selectedContacts.has(c.id))
 const isSomeVisibleSelected = filtered.some(c => selectedContacts.has(c.id)) && !isAllVisibleSelected
...
>
 ...
 const prevSelected = idx> 0 && selectedContacts.has(filtered[idx - 1].id)
 const nextSelected = idx < filtered.length - 1 && selectedContacts.has(filtered[idx + 1].id)
