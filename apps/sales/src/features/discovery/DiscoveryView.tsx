...
import { LocationSelector, type StructuredLocation } from "@/shared/ui/location-selector";
...
export function DiscoveryView() {
  ...
  const handleContinueLocation = async () => {
    ...
    try {
      const res = await discoveryApi.createJob({
              ...
              >
                <PopoverTrigger asChild>
                  ...
                  >
                    <div className="flex items-center min-w-0 flex-1">
                      <span
                        className={cn(
                          ...
                          !business && "text-muted-foreground/60"
                        )}
                      >
                    ...
                    <ChevronDown
                      size={16}
                      className="text-muted-foreground ml-2 shrink-0 opacity-50"
                    />
                  </button>
                </PopoverTrigger>
                <PopoverContent
                  ...
                  <Command>
                    <div className="flex items-center w-full h-[44px] px-5 border-b border-border/40">
                      ...
                      <button
                        ...
                        className="ml-2 text-muted-foreground shrink-0 opacity-50 hover:opacity-100 transition-opacity"
                      >
                        <X size={16} />
                      </button>
                    </div>
                          ...
                          <CommandItem
                            ...
                            className={cn(
                              ...
                              business === cat
                                ...
                                : "text-muted-foreground hover:bg-accent/40 hover:text-foreground aria-selected:bg-accent/40 aria-selected:text-foreground"
                            )}
                          >
                            {cat}
                          </CommandItem>
          ...
          <>
            ...
            <div className="w-full max-w-[280px] mb-[24px] text-left">
              <LocationSelector
                ...
                className={cn(
                  locationError && "ring-2 ring-destructive/80 focus:ring-destructive/80"
                )}
              />
              {locationError && (
                <p className="text-[13px] text-destructive font-medium mt-2 px-1 text-center animate-in fade-in slide-in-from-top-1 duration-200">
